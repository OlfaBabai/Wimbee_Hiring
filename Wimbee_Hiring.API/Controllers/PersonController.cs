...
namespace Wimbee_Hiring.API.Controllers
{
    public class PersonController : Controller
    {
        ...
        public PersonController(CodingBlastDdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPerson,FirstName,LastName,Job,Role")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPerson,FirstName,LastName,Job,Role")] Person person)
        {
